	...
	`};function Ie(e,t=null){return ie`<svg class="icon" width="24" height="24" viewBox="0 0 24 24" role="img" ?aria-hidden=${t} title=${t||""}>
				...
				<div class="media-editor">
					...
					${n.palette?ie`
						<div class="input-row input-row-labeled palette-row">
							Palette
							${Array.isArray(n.palette)&&n.palette.map((n,o)=>ie`
		...
		`}_mediaUploader(e,t,n,r,o){return ie`
			<div class="upload-zone"
				...
				@dragleave=${e=>{if(e.stopPropagation(),e.preventDefault(),this.dragSecond?this.dragSecond=!1:this.dragFirst=!1,!this.dragFirst&&!this.dragSecond)for(const e of this.shadowRoot.querySelectorAll(".upload-zone"))e.classList.remove("dragging")}}
